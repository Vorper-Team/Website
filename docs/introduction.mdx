...
- Access
  - You will recieve access to all repositories owned by the Vorper organization on GitHub
- Hosting
  - You will be provided hosting for any service that you wish to run, shouldn't be too intensive
- Storage
  - You will be given access to a 20 GB private cloud storage solution hosted by us.

You can apply to develop for Vorper [here](mailto:contact@vorper.com).
